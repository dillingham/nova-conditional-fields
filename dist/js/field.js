...
Nova.booting(function (Vue, router, store) {
    Vue.component('detail-conditional', __webpack_require__(3));
    Vue.component('form-conditional', __webpack_require__(6));
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    mounted: function mounted() {
        ...
        this.$parent.$children.forEach(function (component) {
            if (component.field !== undefined && component.field.attribute == _this.field.attribute) {
                _this.value = component.value;
            }
        });
    }
});
...
var render = function() {
  ...
  return _c(
    ...
    [
      _c("h1", [_vm._v("Hello")]),
      _vm._v(" "),
      _vm._l(_vm.field.conditions, function(condition) {
        return _c("div", { key: condition.value }, [
          condition.value == _vm.value
            ? _c(
                "div",
                _vm._l(condition.fields, function(subfield) {
                  return _c(
                    "detail-" + subfield.component,
                    _vm._b(
                      {
                        key: subfield,
                        tag: "component",
              ...
              directives: [
                {
                  name: "show",
                  rawName: "v-show",
                  value: condition.value == _vm.value,
                  expression: "condition.value == value"
                }
              ]
            },
